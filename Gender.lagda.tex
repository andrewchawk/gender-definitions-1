...
\begin{code}
  ...
  AbstractGender {u} UC = UC → Attempt1.Gender → Unitℚ
\end{code}
...
\begin{code}
  AbstractGender : {u : Level} → Set u → Set u
  AbstractGender {u} UC = UC → Attempt1.Gender → I
\end{code}
...
\begin{code}
  ...
  AbstractGender {u} UC = UC → Gender → I
\end{code}
