...
\paragraph{The Equality Relation}
...
\paragraph{The Agender Identity}\label{sec:gender8exampleIdentityAgender}
...
\subparagraph{Proof of \AgdaFunction{basicPangender}'s Pangender Nature}
