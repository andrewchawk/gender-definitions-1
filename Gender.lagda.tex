...
Basically, \AgdaFunction{IEq} \AgdaBound{x} \AgdaBound{y} is populated if and only if \AgdaBound{x} is numerically equal to \AgdaBound{y}.  \AgdaFunction{IEq} is defined as follows:
